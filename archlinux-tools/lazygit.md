...
关系如图![](pic/lazygit_1.png)

**2. master分支向前推进一步**

关系如图![](pic/lazygit_2.png)

<font color=red>**3. 要做到如图该如何操作</font>**
...
**答:在某个commit进入到<font color=red>文件内容浏览模式</font>,使用<font color=#38c83e>space</font>选定想要的内容**
...
<thead>
<tr>
	<th style="text-align:center;" colspan="3">操作1:直接<font color=red>C-u</font>调出<font color=red>Patch Options</font>菜单</th>
</tr>
<tr>
	<th style="text-align:center;">Key</th>
	<th style="text-align:left;">Function</th>
...
<thead>
<tr>
	<th style="text-align:center;" colspan="3">操作2:退回到<font color=red>Commits窗格</font>光标<font color=red>移动到</font>其他的commit上<font color=red>C-u</font></th>
</tr>
<tr>
	<th style="text-align:center;">Key</th>
	<th style="text-align:left;">Function</th>
