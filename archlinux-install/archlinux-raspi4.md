...
- 更新系统并安装必要软件  
	...
	pacman-key --populate
	pacman -Syu
	pacman -Syu sudo base-devel uboot-tools neovim tmux tig git lazygit ripgrep zsh bear fd ccls wget samba iw dialog networkmanager netctl ranger fzf ttf-dejavu wqy-microhei wqy-zenhei xorg-mkfontscale python-pynvim global ctags htop the_silver_searcher wget colordiff python3 python-pip ntp w3m git-delta perl-module-build
	```
